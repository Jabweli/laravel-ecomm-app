<div>
                           ...
                           <div class="product-image-slider">
                              @if ($quick_pdt)
                                 <figure class="border-radius-10">
                                    <img src="{{ asset('storage/products/' . $quick_pdt->image) }}"
                                       alt="product image">
                                 </figure>
                              @endif
                           </div>
                        ...
                        <div class="detail-info">
                           ...
                           <div class="product-detail-rating">
                              <div class="pro-details-brand">
                                    @if ($quick_pdt)
                                       <span> Category: <a
                                                href="{{ url('products/category/' . $quick_pdt->category->slug) }}">{{ $quick_pdt->category->name ?? 'N/A' }}</a></span>
                                    @endif
                              </div>
                           ...
                           <div class="clearfix product-price-cover">
                              <div class="product-price primary-color float-left">
                                    <ins><span
                                          class="text-brand">${{ $quick_pdt->sale_price ?? 'N/A' }}</span></ins>
                                    <ins><span
                                          class="old-price font-md ml-15">${{ $quick_pdt->regular_price ?? 'N/A' }}</span></ins>
                                    <span
                                       class="save-price  font-md color3 ml-15">{{ $quick_pdt->discount ?? 'N/A' }}%
                                       Off</span>
                              </div>
                           </div>
   ...
   <div wire:ignore.self class="modal fade" id="addcartModal" tabindex="-1" aria-labelledby="quickViewModalLabel"
      aria-hidden="true">
