                  ...
                  <div class="row">
                     <div class="col-lg-9">
                        <div class="single-page pr-30">
                           <div class="single-header style-2">
                              ...
                              <div class="single-header-meta">
                                 <div class="entry-meta meta-1 font-xs mt-15 mb-15">
                                    ...
                                    <span class="time-reading has-dot">{{$time}} read</span>
                                    <span class="hit-count  has-dot">29k Views</span>
                                 </div>
                                 <div class="social-icons single-shareddd">
                                    <div class="text-grey-5 d-flex align-center">
                           ...
                           <div class="entry-bottom mt-40 mb-0 wow fadeIn  animated" style="visibility: visible; animation-name: fadeIn;">
                                    ...
                                    @if (!$loop->first)
                                       <div class="col-md-6 col-sm-6 sm-grid-content mb-10">
                                          ...
                                          <div class="post-content media-body">
                                             <h6 class="post-title mb-10 text-limit-2-row">
                                                <a href="{{url('post/'.$post->slug)}}">
                                                   {{strlen($post->title) > 18 ? substr($post->title, 0, 18).'...' : $post->title}}
                                                </a>
                                             </h6>
                                             <div class="entry-meta meta-13 font-xxs color-grey">
