<div>
   <div class="card account-card">
      ...
      <div class="card-body px-md-5 p-lg-4">
         <form wire:submit.prevent="update({{$address_id}})">
            <div class="row">
               <div class="col-md-6">
               ...
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input type="phone" id="mobile" placeholder="Mobile number e.g +1 (23) 900 800" wire:model.defer="phone">
               ...
               <div class="col-md-6">
                  <button type="submit" class="btn">
                     <span wire:loading.remove>UPDATE ADDRESS</span>
