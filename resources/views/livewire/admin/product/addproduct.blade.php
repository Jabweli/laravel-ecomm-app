...
<div>
   ...
   <form wire:submit.prevent="save" class="mt-3">
      <div class="modal-bodydd">
         ...
         <div class="row">
            ...
            <div class="col-md-6">
               ...
               <div class="mt-3">
               @if ($image)
                  <img src="{{ $image->temporaryURL() }}" alt="placeholder" style="width: 230px; height: 220px; object-fit: cover; border-radius: 5px">
               @else
                  <img src="{{asset('admins/images/backgrounds/placeholder.png')}}" alt="placeholder" style="width: 230px; height: 220px; object-fit: cover; border-radius: 5px">
               @endif
         ...
         <div class="row">
            ...
            <div class="col-md-12 mt-4">
               <div class="form-group" wire:ignore>
                  ...
                  <textarea wire:model.defer="additional_info" data-additional="@this" id="additional_info" cols="30" rows="16" class="form-control"
      ...
      @if (session()->has('saved'))
         <h6 class="text-success mt-1">{{ session('saved') }}</h6>
      @endif
   </form>
