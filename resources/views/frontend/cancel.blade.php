...
<div class="vh-90 mt-20 mb-50 d-flex justify-content-center align-items-center">
   <div class="col-md-6">
      ...
      <div class="carddd  bg-white shadowdd p-5">
         ...
         <div class="text-center">
            <h1>You cancelled you order payment!</h1>
            <p class="mb-20">Your order payment was cancelled successfully!</p>
